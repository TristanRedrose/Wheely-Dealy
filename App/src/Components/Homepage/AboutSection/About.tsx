        ...
        <div className="section-box">
            ...
            <div className="about-container">
                <div className="about-box">
                    <img className="about-image" src="../Images/About/browse.webp" alt="Browse" />
                    <h2 className="lobster-text">Step 1</h2>
                    <h3>Browse for your desired vehicle</h3>
                </div>
                <div className="about-box">
                    <img className="about-image" src="../Images/About/agreeing-deal.jpg" alt="Agreeing" />
                    <h2 className="lobster-text">Step 2</h2>
                    <h3>Contact the listing provider and agree to a price</h3>
                </div>
                <div className="about-box">
                    <img className="about-image" src="../Images/About/sunset-car.jpg" alt="Drive-off" />
